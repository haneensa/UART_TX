...
xst -ifn xst.scr
move clock66M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clock66M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clock66M_exdes.ucf clock66M_exdes

echo 'Running map'
map -timing -pr b clock66M_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clock66M_exdes -w routed.ncd routed.vhd
cd ..
